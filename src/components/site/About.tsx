...
const pillars = [
  ...
  { icon: HeartHandshake, t: "Amizade Turbinada", d: "programa de recompensas para quem indica" },
];

const reviews = [
  {
    n: "Neusa Fabiane",
    city: "Medianeira", // TODO: confirmar cidade real
            ...
            {reviews.map((r) => (
              ...
              >
                ...
                <figcaption className="mt-4 flex items-center gap-3">
                  <div className="h-9 w-9 rounded-full bg-primary grid place-items-center text-primary-foreground font-semibold text-sm">
                    {r.n.charAt(0)}
                  </div>
                  <div className="text-sm font-medium">
                    {r.n} <span className="text-background/60">— {r.city}</span>
                  </div>
                </figcaption>
              </figure>
            ))}
